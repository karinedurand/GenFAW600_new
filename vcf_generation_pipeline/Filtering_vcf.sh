...
bcftools view     -m2 -M2 -i 'F_MISSING < 0.8' GenFAW.snps.renamed_chr1-29.vcf.gz \
 -Oz  -o Whole_genome_biallelic_max80missing.vcf.gz \
 --threads 8                     
...
bcftools view \
    -r 1-28 Whole_genome_biallelic_max80missing.vcf.gz \
    -Oz -o Autosome_biallelic_max80missing.vcf.gz \
    --threads 8
...
bcftools view \
    -r 29 Whole_genome_biallelic_max80missing.vcf.gz \
    -Oz  -o Z_biallelic_max80missing.vcf.gz --threads 8
...
bcftools index Whole_genome_biallelic_max80missing.vcf.gz
bcftools index Autosome_biallelic_max80missing.vcf.gz
bcftools index Z_biallelic_max80missing.vcf.gz
